...
public class JavaSourceReader {
    ...
    class CompilationUnitVisitor extends SimpleTreeVisitor<Void, Void> {
        @Override
    ...
    class MethodVisitor extends SimpleTreeVisitor<Void, Void> {
        @Override
    ...
    class ReturnTreeVisitor extends SimpleTreeVisitor<Void, Void> {
        @Override
